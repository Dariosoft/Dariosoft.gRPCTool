...
namespace Dariosoft.gRPCTool.Factories
{
    ...
    {
        Components.IMessageComponent Create(Elements.Element element, EnqueueElement enqueue);
    }
    ...
    {
        public Components.IMessageComponent Create(Elements.Element element, EnqueueElement enqueue)
        {
